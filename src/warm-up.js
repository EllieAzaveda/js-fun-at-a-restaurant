...
var vegetables = ["Broccoli", "Carrots", "Beets", "Onions", "Asparagus"];
...
var fruits = ["Bananas", "Strawberries", "Blueberries", "Mangoes", "Kiwis", "Pineapple", "Watermelon"];
...
var groceryStore = {
  ...
  isOpen: true,
  hoursOpen: 14,
  storeManager: "Lady Gaga",
  covidInStoreCustomerMaximum: 30,
}
console.log(groceryStore);
//I added a few potential value-key pairs for a grocery store :)
